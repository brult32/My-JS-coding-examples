...
let brickLayout = [
	...
	0, 0, 0, 0, 0, 0, 0];
//COLORS&IMAGES
let colors = {text: "#000000", debug: '#0DFF00', ball: '#00ff00', bullet: '#ff0000',
...
let	brickColor = [colors.brick, colors.powerPaddle, colors.powerShot, colors.crushBall, colors.speedBall,
		colors.moveY, colors.brick, colors.brick, colors.brick, colors.unbrick];
// var brickColor = ['#449900','#ff9933','#22c9ff', '#9966ff', '#ff33ff'];
//let imageBG = createImage('background.jpg');
let	ballSprite = [createImage('ball.png'), createImage('goldenball.png'), createImage('speedball.png'), createImage('sgball.png')],
